	...
	--------------------------------------------------------------------------------------------------------------*/
        ...
        var includeAssets = function (callback) {
            ...
            if (config.customScrollbar.enabled) {
                primary.push('/src/css/jquery.mCustomScrollbar.min.css');
                primary.push('/src/js/jquery.mCustomScrollbar.min.js');
            }
            ...
            if (config.editor.enabled) {
                ...
                if (editorTheme && editorTheme !== 'default') {
                    secondary.push('/src/css/codemirror-theme/' + editorTheme + '.css');
                }
                secondary.push('/src/css/codemirror.min.css');
                secondary.push('/src/js/codemirror.min.js');
            }
            ...
            if (config.viewer.markdownRenderer.enabled) {
                ...
                secondary.push('/src/js/markdown-it.min.js');
                secondary.push('/src/css/highlight.min.css');
                secondary.push('/src/js/highlight.pack.min.js');
            }
            ...
            if (!config.options.browseOnly) {
                ...
                if (config.upload.multiple) {
                    secondary.push('/src/css/dropzone.css');
                }
            }
        ...
        var FmModel = function () {
            ...
            var PreviewModel = function () {
                ...
                this.afterRender = function () {
                    ...
                    clipboard = new ClipboardJS(copyBtnEl);
            ...
            var EditorModel = function () {
                ...
                function includeAssets(extension) {
                    var assets = ['/src/js/codemirror-modes.min.js'],
                        currentMode = 'default';
                        ...
                        .on('fileuploadadd', function (e, data) {
                            ...
                            $.each(data.files, function (index, file) {
                                ...
                                var $template = $(tmpl('tmpl-upload-item', {
                                    file: file,
                                    lang: langModel.getTranslations(),
                                    imagesPath: fm.settings.baseUrl + '/src/img'
                                }));
