{
    ...
    "FORBIDDEN_CHAR_SLASH": "El uso de '/' está prohibido en el directorio o nombre de archivo.",
    ...
    "download": "Descargar", 
    "dz_dictDefaultMessage": "Suelte los archivos aquí para cargarlos",
    "dz_dictFallbackMessage": "Su navegador no soporta arrastrar y soltar la carga de archivos.",
    "dz_dictInvalidFileType": "No se pueden cargar archivos de este tipo.",
    "dz_dictMaxFilesExceeded": "Sólo se permiten %s subidas simultáneas.",
    "edit": "Editar el archivo",
    "fck_select_integration": "La función 'Seleccionar' solo se puede utilizar desde FCKEditor.", 
    "file_size_limit": "El límite de tamaño de archivo es: ",
    "file_too_big": "El archivo es demasiado grande.",
    "gb": "gb", 
    "grid_view": "Cambiar a vista de cuadrícula.", 
    "help_move": "El uso de '../' está prohibido. Puede acceder a la carpeta raíz mediante '/'.",
    "items": "items", 
    "kb": "kb", 
