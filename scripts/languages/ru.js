{
    "ALLOWED_FILE_TYPE": "Разрешены только указанные типы файлов: ",
    ...
    "DISALLOWED_FILE_TYPE": "Указанные типы файлов запрещены: ",
    ...
    "ERROR_REPLACING_FILE": "Выберите файл с расширением: ",
    ...
    "FORBIDDEN_ACTION_DIR": "Невозможно выполнить операцию. Запрещено для папок.",
    "FORBIDDEN_ACTION_FILE": "Невозможно выполнить операцию. Запрещено для файлов.",
    "FORBIDDEN_CHAR_SLASH": "Использование '/' в имени папки или файла запрещено.",
    ...
    "type": "Тип",
    "upload": "Загрузить",
    "upload_action_abort": "Остановить",
    "upload_action_delete": "Удалить",
    "upload_action_info": "Информация",
    "upload_action_resume": "Возобновить",
    ...
    "upload_file_size_limit": "Ограничение на размер файла: ",
    "upload_file_too_big": "Файл слишком большой.",
    "upload_file_type_invalid": "Вы не можете загружать файлы этого типа.",
    "upload_files_number_limit": "Вы можете загружать только %s файлов одновременно.",
    "upload_failed": "Ошибка загрузки. Файл не загружен.",
    "upload_failed_details": "Для просмотра детальной информации наведите указатель мыши на файлы в очереди.",
    "upload_successful_file": "Файл успешно загружен.",
    "upload_successful_files": "Файлы успешно загружены.",
    "upload_partially": "Некоторые файлы не были загружены.",
    "version": "Версия",
    "yes": "Да"
}